...
def _quit():
    ...
    """
    plt.close("all") # closes all image
...
def openInstrucktion():
    os.startfile("Images\\Instructions.pdf")
...
button6 = Button(root,text="6. Pie chart of total number of samples \n per product for all clients", command=act_button6, bg=bgcolor, fg=fgcolor)
